...
class EdictMoneyTeam:
    """A small local implementation of the Edict 三省六部 workflow for work decisions."""
    ...
    def __init__(self) -> None:
        self.stages = (
            ...
            DepartmentReport(
                ...
                (
                    "Collect opportunity snapshots from approved work channels.",
...
def demo_opportunities() -> tuple[Opportunity, ...]:
    return (
        Opportunity(
            ...
            platform="Upwork",
            url="https://example.com/opportunities/python-automation-workflow",
        ...
        Opportunity(
            ...
            platform="Upwork",
            url="https://example.com/opportunities/google-maps-api",
        ...
        Opportunity(
            ...
            platform="Upwork",
            url="https://example.com/opportunities/senior-ai-saas",
